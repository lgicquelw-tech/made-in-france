...
__export(constants_exports, {
  AI_INTENT_LABELS: () => AI_INTENT_LABELS,
  API_ROUTES: () => API_ROUTES,
  COMMON_TAGS: () => COMMON_TAGS,
  DEFAULT_PAGE_SIZE: () => DEFAULT_PAGE_SIZE,
  FRANCE_BOUNDS: () => FRANCE_BOUNDS,
  FRANCE_CENTER: () => FRANCE_CENTER,
  MADE_IN_FRANCE_COLORS: () => MADE_IN_FRANCE_COLORS,
  MADE_IN_FRANCE_LABELS: () => MADE_IN_FRANCE_LABELS,
