 ...
 *
 * Reste `'use client'` pour la galerie, la mise en favori et le repli de logo,
 * mais **reçoit ses données en props** : c'est ce qui met le contenu dans le
 * HTML servi. Auparavant, le produit était chargé dans un `useEffect` et la
