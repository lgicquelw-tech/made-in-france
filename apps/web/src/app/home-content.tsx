...
// ===== HERO SLIDER =====
function HeroSlider({ brands }: { brands: WeeklyBrand[] }) {
...
// ===== TRENDING PRODUCTS =====
function TrendingProducts({ products }: { products: TrendingProduct[] }) {
...
// ===== COLLECTIONS GRID =====
function CollectionsGrid({ collections }: { collections: HomeCollection[] }) {
 ...
 *
 * Reste `'use client'` — carrousel, assistant, animations — mais **les quatre
 * jeux de données arrivent en props**. Ils étaient auparavant chargés par
 * quatre `useEffect` distincts : la vitrine du site ne contenait donc aucun
 * contenu dans le HTML servi.
 */
export default function HomePage({
  ...
  return (
    <main className="bg-france-cream">
      <HeroSlider brands={featuredBrands} />
