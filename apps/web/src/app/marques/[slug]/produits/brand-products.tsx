 ...
 *
 * Reste `'use client'` pour la recherche, le tri et le « voir plus », mais
 * reçoit la marque et ses produits en props.
 */
export default function BrandProducts({ brand, products }: BrandProductsProps) {
