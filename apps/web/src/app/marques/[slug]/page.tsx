      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {products.slice(0, 9).map((product) => (
          ...
          >
            ...
            <div className="p-3">
              <h3 className="font-medium text-gray-900 text-sm line-clamp-2 group-hover:text-france-blue transition-colors">
                {product.name}
              </h3>
              {product.priceMin && (
      ...
      {products.length > 9 && (
        <div className="mt-6 text-center">
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-white transition-colors hover:opacity-90"
            style={{ backgroundColor: sectorColor }}
          >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            {similarBrands.length > 0 && (
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                ...
                <Link 
                  href={`/secteurs/${brand.sector?.slug}`}
                  className="inline-block mt-4 text-france-blue hover:underline text-sm"
                >
          ...
          <div className="space-y-6">
                ...
                {brand.yearFounded && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-gray-900 font-medium">{brand.yearFounded}</dd>
                    </div>
                  </div>
                )}
                ...
                {brand.employeeRange && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-gray-900 font-medium">{brand.employeeRange}</dd>
                    </div>
                  </div>
                )}
              </dl>
            ...
            {brand.labels && brand.labels.length > 0 && (
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <h3 className="font-semibold text-gray-900 mb-4">Labels & Certifications</h3>
            ...
            {brand.galleryUrls && brand.galleryUrls.length > 0 && (
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <h3 className="font-semibold text-gray-900 mb-4">Galerie photos</h3>
