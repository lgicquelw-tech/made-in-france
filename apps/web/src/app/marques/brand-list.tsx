 ...
 * Liste des marques.
 *
 * Reste `'use client'` pour ses filtres, mais **la première page arrive en
 * props depuis le serveur** : le HTML servi contient déjà 12 marques et le
 * total réel, au lieu d'un « Chargement… ».
 *
 * Les changements de filtre continuent d'interroger l'API — le modèle
 * d'interaction n'a pas été touché. Le faire passer par l'URL (chaque filtre
 * devenant une page indexable) est un chantier distinct, noté en T4.1.
 */
