 ...
 * Grille des régions.
 *
 * Reste `'use client'` pour la bascule liste/carte et le survol de la carte
 * SVG, mais **reçoit les régions en props** : le HTML servi contient les
 * treize régions et leurs compteurs, au lieu d'un écran de chargement.
 */
